...
func main() {
	...
	// 	*resistor.NewResistor(36000.0, 2.0, 0.015, resistor.GetHollowMaterial(), env),
	// 	*resistor.NewResistor(810000.0, 20.0, 0.075, resistor.GetHollowMaterial(), env),
	// 	*resistor.NewResistor(10000.0, 10.0, 0.005, resistor.GetHollowMaterial(), env),
	// 	*resistor.NewResistor(100000.0, 10.0, 0.050, resistor.GetHollowMaterial(), env),
	// 	*resistor.NewResistor(1000000.0, 20.0, 0.120, resistor.GetHollowMaterial(), env),
	// 	*resistor.NewResistor(220000.0, 20.0, 0.020, resistor.GetHollowMaterial(), env),
	// 	*resistor.NewResistor(140000.0, 20.0, 0.015, resistor.GetHollowMaterial(), env),
	// 	*resistor.NewResistor(150000.0, 10.0, 0.006, resistor.GetHollowMaterial(), env),
	// 	*resistor.NewResistor(330000.0, 20.0, 0.060, resistor.GetHollowMaterial(), env),
	// }
